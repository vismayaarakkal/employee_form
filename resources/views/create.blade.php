      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <form action = "insert" enctype="multipart/form-data" method = "post" id="add-employee" class="form-horizontal">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" placeholder="Name Here" name="emp_name" required/>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <select name="emp_designation" id="designation" class="select2 form-select shadow-none" style="width: 100%; height: 36px" required >
                        @foreach ($designations as $designation) 
                          <option value="{{ $designation->d_id }}">{{ $designation->d_name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
